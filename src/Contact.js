    ...
    return (
        <div id='contact-page' className='contact'> 
            <div className="contact-inside">
                ...
                <h1>Get In Touch</h1>
                <p>Although I'm currently looking for new opportunities to bring best from me, my inbox is always open. Whether you have a question or just want to say hi, I'll try my best to get back to you!</p>
                ...
                <p className="email">pushpeshsharma147@gmail.com</p>
