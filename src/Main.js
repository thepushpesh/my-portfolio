    ...
    return (
        <div id='main-page' className='main'>
            <div className="main-inside">
                ...
                <p>I am a self-taught Frontend Developer with 
                    skilled in solving problems in HTML, CSS, 
                    JavaScript, and React. I Focus on being a 
                    valuable part of a team or as a Person, 
                    I help People, Companies to Accomplish what
                     they need by developing Beautiful and easy
                      Interface sites..</p>
